...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full flex items-center justify-between py-4 px-6 font-medium bg-white z-50 shadow-sm">
          ...
          {token && (
            <div className="group-hover:block hidden absolute dropdowm-menu right-0 pt-4">
              <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded">
                <p className="cursor-pointer hover:text-hoverPurple">
                  My Profile
                </p>
                <p onClick={()=>navigate('/orders')} className="cursor-pointer hover:text-hoverPurple">Orders</p>
                <p
                  onClick={logout}
      ...
      <div
        className={`fixed top-0 right-0 bottom-0 h-screen bg-white transition-all duration-300 ease-in-out z-[9998] ${
