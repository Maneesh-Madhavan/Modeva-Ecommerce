...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-6 pt-4 sm:pt-8 min-h-[80vh] px-4 sm:px-8'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          <input required onChange={onChangeHandler} name='firstName' type="text" value={formData.firstName} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='First name' />
      ...
      <div className='flex flex-col gap-8 w-full sm:max-w-[480px]'>
        ...
        <div>
          ...
          <div className='w-full text-end mt-8'>
            <button type='submit' className='bg-black text-white px-16 py-3 text-sm'>PLACE ORDER
